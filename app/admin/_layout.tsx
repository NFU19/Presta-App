...
import { View, StyleSheet, Text, TouchableOpacity, Platform, useWindowDimensions, Modal, ScrollView } from 'react-native';
...
const AdminLayout = () => {
  ...
  const SidebarContent = () => (
    <>
      ...
      <ScrollView style={styles.sidebarScroll}>
        <TouchableOpacity style={styles.sidebarLink} onPress={() => navigateTo('/admin')}>
          <Ionicons name="stats-chart" size={20} color="#fff" style={styles.icon} />
          <Text style={styles.sidebarLinkText}>Dashboard</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.sidebarLink} onPress={() => navigateTo('/admin/equipos')}>
  ...
  return (
    <View style={styles.container}>
      ...
      {(isMobile || isTablet) && (
        <View style={styles.mobileHeaderSafeArea}>
          <View style={styles.mobileHeader}>
            ...
            <Text style={styles.mobileHeaderTitle}>Dashboard de Administrador</Text>
          </View>
        </View>
      )}
      ...
      {/* Content Area */}
      <View style={[styles.mainContent, (isMobile || isTablet) && styles.mainContentMobile]}>
