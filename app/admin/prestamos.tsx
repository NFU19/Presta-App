...
const PrestamosAdminScreen = () => {
  ...
  const [selectedSolicitud, setSelectedSolicitud] = useState<Prestamo | null>(null);
  ...
  const getEstadoBadge = (estado: EstadoPrestamo) => {
    const config = {
      ...
      aprobado: { label: 'Aprobado', color: '#17a2b8', icon: 'checkmark-circle-outline' },
      activo: { label: 'Activo', color: '#28a745', icon: 'play-circle-outline' },
    };
    const { label, color, icon } = config[estado as keyof typeof config] || config.pendiente;
    ...
    <ScrollView style={styles.container}>
      ...
      {loading ? (
        ...
        <View style={styles.emptyState}>
          <Ionicons name="folder-open-outline" size={64} color={Colors.light.gray} />
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalActions}>
              ...
              <TouchableOpacity
                style={[
                  styles.modalButton,
                  actionType === 'aprobar' ? styles.confirmButton : styles.rejectModalButton,
                  processing && styles.disabledButton,
                ]}
                onPress={handleConfirm}
                disabled={processing || (actionType === 'rechazar' && !motivoRechazo.trim())}
              >
                {processing ? (
